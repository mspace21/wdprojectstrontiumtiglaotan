...
import { PlusCircle, Trash2, CheckCircle, Edit, Save, Minimize } from 'lucide-react';
...
export default function HomePage() {
  ...
  return (
    <div className="w-full h-auto bg-white rounded-md p-4 shadow-sm relative">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold text-gray-800 mb-6">Workout Dashboard</h1>
        <a href="/fitness">
          <Minimize className="absolute right-2 top-2" />
        </a>
